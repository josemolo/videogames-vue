  ...
  <div class="shop-wrapper">
    <section class="shop">
        ...
        <div class="shop-grid">
            ...
            <div class="shop-card" @click="goTo('/tienda/consolas')">
                <img src="/images/consolas.png" alt="Consolas">
                <div class="overlay">
                <h2>Consolas</h2>
                </div>
            </div>
...
const consolesCount = consolesData.length
...
.shop-title {
  ...
  margin-bottom: 60px;
  letter-spacing: 3px;
  background: linear-gradient(90deg, #7f5cff, #ff00ff);
